  ...
  return (
    <div className="group bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
      <div className="relative">
        ...
        <button
          className="absolute top-3 right-3 p-2 bg-white/80 backdrop-blur-sm rounded-full opacity-0 group-hover:opacity-100 transition-opacity z-10"
      ...
      <Link to={`/course/${id}`} className="block p-5 space-y-3">
      ...
      <div className="px-5 pb-5">
        <div className="pt-2 flex items-center justify-between border-t border-gray-50">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full hover:bg-[#1a365d] hover:text-white"
            onClick={(e) => e.preventDefault()}
          >
